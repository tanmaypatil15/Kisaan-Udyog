...
<head>
    ...
    <div class="main-wrapper">
            ...
            <!-- cart start -->
            <div class="cart-main-area pt-110">
                <div class="container">
                    <div class="row">
                                            ...
                                            <tbody>                                     
                                                <?php 
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="product-price"><?php echo '₹'.$item["price"].' INR'; ?></td>
                                                        <td class="cart-quality product-details-quality quality-width-cart"><input class="form-control" type="number" value="<?php echo $item["qty"]; ?>" onchange="updateCartItem(this, '<?php echo $item["rowid"]; ?>')"/></td>
                                                    ...
                                                    <!-- <tr>
                                                        ...
                                                        <td class="product-total"><strong>?php echo '$'.$cart->total().' USD'; ?></strong></td>
                                                        <td></td>
                                                    </tr> -->
                                                <?php } ?>
                                            </tbody>
                                ...
                                <div class="col-lg-4">
                                    <div class="grand-total-wrap">
                                        ...
                                        <div class="grand-total-content">
                                            <ul>
                                                <li>Total <span><?php echo '₹'.$cart->total().' INR'; ?></span></li>
                                                <li>Shipping
                                                    <ul>
                                                ...
                                                <li>Total Price <span><?php echo '₹'.$cart->total().' INR'; ?></span> </li>
                                            </ul>
                                        </div>
                                        <div class="grand-btn">
                                            <?php if($cart->total_items() > 0){ ?>
