...
if(isset($_REQUEST['action']) && !empty($_REQUEST['action'])){ 
    if($_REQUEST['action'] == 'addToCart' && !empty($_REQUEST['id'])){ 
        ...
        $order_notes = strip_tags($_POST['order_notes']);
        ...
        if(empty($postcode)){ 
            $errorMsg .= 'Please enter your postcode.<br/>'; 
        }
        if(empty($city)){ 
        ...
        if(empty($order_notes)){ 
            $errorMsg .= 'Please enter your order notes.<br/>'; 
        }
        // if(empty($payment_method)){ 
        //     $errorMsg .= 'Please enter your payment method.<br/>'; 
        // }
                 
        if(empty($errorMsg)){ 
            // Insert customer data in the database 
            $insertCust = $db->query("INSERT INTO customers (first_name, last_name, email, phone, address, postcode, city, state, country, order_notes) 
            VALUES ('".$first_name."', '".$last_name."', '".$email."', '".$phone."', '".$address."', '".$postcode."', '".$city."', '".$state."', '".$country."', '".$order_notes."')"); 
