                            ...
                            <div class="login-register-form">
                                ...
                                <form action="login.php" method="post">
                                    ...
                                    <div class="sin-login-register ">
                                        <input type="text" name="username" placeholder="Enter Your User-name *" class="form-control" value="<?php echo $username; ?>">
                                    ...
                                    <div class="login-register-btn">
                                        <button class="login" type="submit" name="login_btn" value="Login">Login</button>
                                        <!-- <button class="login-fb" type="submit">Login with Facebook</button> -->
