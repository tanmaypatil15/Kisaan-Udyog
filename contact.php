                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-12 col-md-12 col-12">
                                                    <select name="subject">
                                                        ...
                                                        <option value="Inquiry 1">Complaint</option>
                                                        <option value="Inquiry 2">Request</option>
                                                        <option value="Inquiry 2">Appreciation</option>
                                                        <option value="Inquiry 2">Others</option>
                                                    </select>
                                                </div>
                                                <div class="col-lg-12 col-md-12 col-12">
                                                ...
                                                <div class="col-lg-12 col-md-12 col-12">
                                                    ...
                                                    <button class="submit" type="reset" name="Reset" value="Reset">Reset</button>
                                                </div>
                                            </div>
                                        </form>
                                ...
                                <div class="col-xl-3 col-lg-4 col-md-5">
                                    <div class="contact-info-area">
                                        ...
                                        <div class="contact-info-top">
                                            <div class="sin-contact-info-wrap mb-25">
                                                <div class="contact-address">
                                                    <i class="ti-home"></i>
                                                    <span>Kisaan Udyog Headquarter</span>
                                                </div>
                                            ...
                                            <div class="sin-contact-info-wrap">
                                                <div class="contact-address">
                                                    <i class="ti-home"></i>
                                                    <span>Kisaan Udyog Pune Branch</span>
                                                </div>
                                        ...
                                        <div class="contact-info-bottom">
                                            <ul>
                                                <li><i class=" ti-email "></i>info@kisaanudyog.com</li>
                                                <li><i class="ti-mobile"></i>+1812-466-7130</li>
                                            </ul>
